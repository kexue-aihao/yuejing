    ...
    <div class="author-layout">
        <section class="panel">
            ...
            <form class="form-stack" method="POST" action="{{ route('author.submissions.store') }}" enctype="multipart/form-data" data-markdown-editor>
                ...
                <div class="form-field"><label for="cover">{{ __('ui.author.cover_label') }}</label><div class="cover-preview-control" data-vue-cover-preview data-input-id="cover" data-input-name="cover" data-accept="image/jpeg,image/png,image/webp" data-required="1" data-preview-alt="{{ __('ui.author.cover_label') }}" data-description-id="cover-help"><input id="cover" name="cover" type="file" accept="image/jpeg,image/png,image/webp" required data-cover-input><img class="cover-upload-preview" data-cover-preview alt="{{ __('ui.author.cover_label') }}" hidden></div><p id="cover-help" class="form-help">{{ __('ui.author.cover_help') }}</p></div>
                ...
                <div class="form-field manuscript-editor-field">
                    ...
                    <span class="markdown-editor-vue-island" data-vue-markdown-editor aria-hidden="true"></span>
