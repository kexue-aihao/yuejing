        ...
        <div class="dashboard-content">
            ...
            <section class="panel">
                <form class="form-stack" method="POST" action="{{ route('author.novels.update', $novel) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-field cover-upload-field"><label for="cover">{{ __('ui.author.replace_cover') }}</label><input id="cover" name="cover" type="file" accept="image/jpeg,image/png,image/webp" data-cover-input><img class="cover-upload-preview" data-cover-preview alt="{{ __('ui.author.cover_label') }}" hidden><p class="form-help">{{ __('ui.author.cover_edit_help') }}</p></div>
