        ...
        <div class="dashboard-content">
            ...
            @forelse ($submissions as $submission)
                <article class="panel submission-review-card">
                    ...
                    <details class="manuscript-details"><summary>查看首章稿件</summary><div class="manuscript-preview markdown-preview">{!! $submission->manuscript_html !!}</div><details class="manuscript-source"><summary>查看 Markdown 原文</summary><pre>{{ $submission->manuscript }}</pre></details></details>
