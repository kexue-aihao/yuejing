    ...
    <div class="dashboard-grid">
        ...
        <div class="dashboard-content">
            ...
            <form class="panel form-stack" method="POST" action="{{ route('admin.settings.update') }}">
                ...
                <div class="form-field"><label class="check-row"><input type="hidden" name="email_verification_required" value="0"><input type="checkbox" name="email_verification_required" value="1" @checked(old('email_verification_required', $settingValues['email_verification_required']))> {{ __('ui.admin.email_verification_required') }}</label><p class="field-hint">{{ __('ui.admin.email_verification_hint') }}</p></div>
                <div class="settings-grid">
